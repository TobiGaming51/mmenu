...
-- GENERAL --
Config.MenuTitle = 'YOUR SERVER' -- change it to you're server name
...
-- GPS --
Config.GPS = {
	{label = 'Keine', coords = nil},
	{label = 'Polizei', coords = vector2(425.13, -979.55)},
	{label = 'MP', coords = vector2(-449.67, -340.83)},
	{label = 'Krankenhaus', coords = vector2(-33.88, -1102.37)},
	{label = 'Händler', coords = vector2(215.06, -791.56)},
